                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-2">
                                    ...
                                    <input
                                        ...
                                        data-testid="db-config-name-input"
                                    />
                                </div>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-800 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-cyan-500/50 placeholder:text-slate-600"
                                        data-testid="db-config-variable-input"
                                    />
                                </div>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-800 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-cyan-500/50 placeholder:text-slate-600"
                                        data-testid="db-config-host-input"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="请输入数据库名"
                                        className="w-full bg-slate-800 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-cyan-500/50 placeholder:text-slate-600"
                                        data-testid="db-config-database-input"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="请输入用户名"
                                        className="w-full bg-slate-800 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-cyan-500/50 placeholder:text-slate-600"
                                        data-testid="db-config-username-input"
                                    />
                                </div>
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            data-testid="db-config-password-input"
                                        />
                                        <button
                                            type="button"
