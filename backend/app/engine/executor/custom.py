...
from app.engine.core.models import CustomParams
from app.engine.errors import KEYWORD_EXECUTION_ERROR, KEYWORD_NOT_FOUND, EngineError
from app.engine.result.models import CustomDetail
...
def execute_custom_step(
    ...
    from app.engine.utils.variables import render_template
