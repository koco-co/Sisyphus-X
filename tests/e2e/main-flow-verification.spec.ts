  ...
  test('完整主干流程验证', async ({ page }) => {
    ...
    try {
      ...
      if (!createButtonFound) {
        // 截图记录当前页面状态
        await page.screenshot({ path: `tests/e2e/test-results/step1-no-create-button-${timestamp}.png`, fullPage: true });
      ...
      if (!nameInputFilled) {
        await page.screenshot({ path: `tests/e2e/test-results/step1-no-name-input-${timestamp}.png`, fullPage: true });
      ...
      if (!saveButtonClicked) {
        await page.screenshot({ path: `tests/e2e/test-results/step1-no-save-button-${timestamp}.png`, fullPage: true });
      ...
      await page.screenshot({ path: `tests/e2e/test-results/step1-success-${timestamp}.png`, fullPage: true });
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step1-error-${timestamp}.png`, fullPage: true });
    ...
    try {
      ...
      if (!keywordButtonFound) {
        ...
        await page.screenshot({ path: `tests/e2e/test-results/step2-skip-${timestamp}.png`, fullPage: true });
      } else {
        ...
        await page.screenshot({ path: `tests/e2e/test-results/step2-success-${timestamp}.png`, fullPage: true });
      }
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step2-error-${timestamp}.png`, fullPage: true });
    ...
    try {
      ...
      // 选择项目
      const projectSelector = page.locator('button:has-text("Select Project"), button:has-text("选择项目"), [placeholder*="Select Project" i], [placeholder*="选择项目"]').first();
      ...
      const createInterfaceButtons = [
        ...
        'button:has-text("Add Interface")',
        'button:has-text("新建接口")',
        'button:has-text("添加接口")'
      ];
      
      let interfaceButtonFound = false;
      for (const selector of createInterfaceButtons) {
        try {
          const button = page.locator(selector).first();
          if (await button.isVisible({ timeout: 2000 })) {
            await button.click();
      ...
      if (!interfaceButtonFound) {
        await page.screenshot({ path: `tests/e2e/test-results/step3-no-button-${timestamp}.png`, fullPage: true });
      ...
      // 选择 GET 方法
      const methodSelector = page.locator('select[name="method"], button:has-text("GET"), button:has-text("POST")').first();
      if (await methodSelector.isVisible({ timeout: 2000 })) {
        if ((await methodSelector.tagName()) === 'select') {
      ...
      await page.screenshot({ path: `tests/e2e/test-results/step3-success-${timestamp}.png`, fullPage: true });
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step3-error-${timestamp}.png`, fullPage: true });
    ...
    try {
      ...
      if (!scenarioButtonFound) {
        await page.screenshot({ path: `tests/e2e/test-results/step4-no-button-${timestamp}.png`, fullPage: true });
      ...
      await page.screenshot({ path: `tests/e2e/test-results/step4-success-${timestamp}.png`, fullPage: true });
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step4-error-${timestamp}.png`, fullPage: true });
    ...
    try {
      ...
      if (!planButtonFound) {
        await page.screenshot({ path: `tests/e2e/test-results/step5-no-button-${timestamp}.png`, fullPage: true });
      ...
      await page.screenshot({ path: `tests/e2e/test-results/step5-success-${timestamp}.png`, fullPage: true });
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step5-error-${timestamp}.png`, fullPage: true });
    ...
    try {
      ...
      if (!viewButtonFound) {
        await page.screenshot({ path: `tests/e2e/test-results/step6-no-button-${timestamp}.png`, fullPage: true });
      ...
      // 截图记录报告详情
      await page.screenshot({ path: `tests/e2e/test-results/step6-report-detail-${timestamp}.png`, fullPage: true });
      
      console.log(`✓ 步骤 F 成功: 报告详情页面正常显示`);
      console.log('\n========== ✅ 已跑通到报告详情 ==========\n');
      
    } catch (error) {
      await page.screenshot({ path: `tests/e2e/test-results/step6-error-${timestamp}.png`, fullPage: true });
