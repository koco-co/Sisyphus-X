...
class ProjectBase(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=200, description="项目描述，最多200个字符")
...
class ProjectUpdate(BaseModel):
    """更新项目时的请求模型"""
    name: Optional[str] = Field(None, min_length=1, max_length=50, description="项目名称，1-50个字符")
    description: Optional[str] = Field(None, max_length=200, description="项目描述，最多200个字符")
