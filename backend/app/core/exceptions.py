...
def handle_resource_not_found(exc: ResourceNotFoundException) -> HTTPException:
    ...
    return HTTPException(
        ...
        detail={"error_type": "resource_not_found", "message": exc.message, "details": exc.details},
    )
...
def handle_validation(exc: ValidationException) -> HTTPException:
    ...
    return HTTPException(
        ...
        detail={"error_type": "validation_error", "message": exc.message, "details": exc.details},
    )
...
def handle_permission_denied(exc: PermissionDeniedException) -> HTTPException:
    ...
    return HTTPException(
        ...
        detail={"error_type": "permission_denied", "message": exc.message, "details": exc.details},
    )
...
def handle_execution(exc: ExecutionException) -> HTTPException:
    ...
    return HTTPException(
        ...
        detail={"error_type": "execution_error", "message": exc.message, "details": exc.details},
    )
