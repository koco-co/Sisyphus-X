"""YAML 配置模型与解析单元测试（EG-003/EG-004）"""
...
from sisyphus_api_engine.models import CaseModel, Config, RequestStepParams, StepDefinition
...
def test_load_case_file_not_found():
    ...
    from sisyphus_api_engine.runner import load_case
