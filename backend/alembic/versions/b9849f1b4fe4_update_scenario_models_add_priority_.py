...
def upgrade() -> None:
    ...
    with op.batch_alter_table("scenarios", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_scenarios_created_by"), ["created_by"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_scenarios_project_id"), ["project_id"], unique=False
        )
    ...
    # 先删除依赖表 plan_execution_steps，再删除 test_plan_executions
    with op.batch_alter_table("plan_execution_steps", schema=None) as batch_op:
        ...
        batch_op.drop_index(
            batch_op.f("ix_plan_execution_steps_test_plan_execution_id")
        )
    ...
    with op.batch_alter_table("datasets", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "scenario_id", existing_type=sa.VARCHAR(length=36), nullable=True
        )
        batch_op.create_index(
            batch_op.f("ix_datasets_project_id"), ["project_id"], unique=False
        )
        ...
        batch_op.create_foreign_key(
            None, "scenarios", ["scenario_id"], ["id"], ondelete="CASCADE"
        )
        batch_op.drop_column("data")

    with op.batch_alter_table("projects", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_projects_created_by"), ["created_by"], unique=False
        )
    ...
    with op.batch_alter_table("scenario_steps", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_scenario_steps_scenario_id", ["scenario_id"], unique=False
        )
        batch_op.create_index(
            "idx_scenario_steps_sort_order", ["sort_order"], unique=False
        )
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_users_oauth", ["oauth_provider", "oauth_id"], unique=True
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("scenario_steps", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("keyword_id", sa.VARCHAR(length=36), nullable=True)
        )
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            None, "test_scenarios", ["scenario_id"], ["id"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            None, "keywords", ["keyword_id"], ["id"], ondelete="SET NULL"
        )
        batch_op.drop_index("idx_scenario_steps_sort_order")
        batch_op.drop_index("idx_scenario_steps_scenario_id")
        batch_op.create_index(
            batch_op.f("idx_scenario_steps_scenario_order"),
    ...
    with op.batch_alter_table("datasets", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "scenario_id", existing_type=sa.VARCHAR(length=36), nullable=False
        )
    ...
    with op.batch_alter_table("database_configs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_database_configs_project_id"), ["project_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_database_configs_project_variable"),
    ...
    with op.batch_alter_table("test_plans", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_test_plans_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_test_plans_project_id"), ["project_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["test_plan_execution_id"], ["test_plan_executions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("plan_execution_steps", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_plan_execution_steps_status"), ["status"], unique=False
        )
    ...
    with op.batch_alter_table("env_variables", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_env_variables_is_global"), ["is_global"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_env_variables_environment_id"),
            ["environment_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("idx_env_variables_env_name_global"),
            ["environment_id", "name", "is_global"],
            unique=1,
        )
    ...
    with op.batch_alter_table("test_scenarios", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_test_scenarios_project_id"), ["project_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["test_plan_id"], ["test_plans.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("test_plan_executions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_test_plan_executions_test_plan_id"),
            ["test_plan_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_test_plan_executions_status"), ["status"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["scenario_id"], ["test_scenarios.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["test_plan_id"], ["test_plans.id"], ondelete="CASCADE"
        ),
    ...
    with op.batch_alter_table("plan_scenarios", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_plan_scenarios_test_plan_id"), ["test_plan_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_plan_scenarios_scenario_id"), ["scenario_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("idx_plan_scenarios_plan_order"),
            ["test_plan_id", "execution_order"],
            unique=1,
        )
