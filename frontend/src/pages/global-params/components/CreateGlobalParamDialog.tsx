...
interface CreateGlobalParamDialogProps {
    isOpen: boolean
    onClose: () => void
...
// 默认代码模板
const DEFAULT_CODE = `class StringUtils:
    """字符串工具类"""
    ...
    def generate_uuid(self) -> str:
        ...
        Returns:
            str: UUID 字符串，格式为 xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
    ...
    def random_string(self, length: int = 10) -> str:
        ...
        Args:
            length (int): 字符串长度，默认为 10

        Returns:
            str: 随机字符串，包含大小写字母和数字
...
export default function CreateGlobalParamDialog({
    isOpen,
    onClose,
    onSubmit,
    isSubmitting
}: CreateGlobalParamDialogProps) {
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                                    <div className="flex items-center gap-3">
                                        <h2 className="text-xl font-semibold text-white">创建全局参数</h2>
                                        <button
