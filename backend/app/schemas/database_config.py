...
class DatabaseConfigBase(BaseModel):
    ...
    variable_name: str | None = Field(None, max_length=255, description="引用变量名")
    ...
    initial_database: str | None = Field(None, max_length=255, description="初始数据库名")
...
class DatabaseConfigUpdate(BaseModel):
    ...
    name: str | None = Field(None, min_length=1, max_length=255, description="连接名称")
    variable_name: str | None = Field(None, max_length=255, description="引用变量名")
    ...
    initial_database: str | None = Field(None, max_length=255, description="初始数据库名")
    username: str | None = Field(None, min_length=1, max_length=255, description="用户名")
    password: str | None = Field(None, min_length=1, max_length=255, description="密码")
    is_enabled: bool | None = Field(None, description="是否启用")
    connection_status: str | None = Field(None, max_length=50, description="连接状态")
